...
// ../.wrangler/tmp/bundle-w6PLUA/checked-fetch.js
...
// ../.wrangler/tmp/bundle-w6PLUA/strip-cf-connecting-ip-header.js
...
function pickLatest(files, appName) {
...
async function onRequestGet({ env }) {
  ...
  try {
    const apiUrl = `https://api.github.com/repos/${cfg.owner}/${cfg.repo}/contents/${cfg.buildDir}?ref=${cfg.branch}`;
...
async function onRequest(context) {
  ...
  const src = `https://raw.githubusercontent.com/${cfg.owner}/${cfg.repo}/${cfg.branch}/${cfg.buildDir}/${f}`;
  const fwdHeaders = {};
  const range = request.headers.get("Range");
  if (range)
    fwdHeaders["Range"] = range;
...
// ../.wrangler/tmp/pages-MToWmP/functionsRoutes-0.02050556987168961.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-w6PLUA/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-w6PLUA/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.65062861646103.mjs.map
