...
صفحه دانلود دارک، نئونی و کاملاً ریسپانسیو با تشخیص خودکار آخرین نسخه.

## ویژگی‌ها
- 🎨 طراحی دارک / نئون (بنفش · مشکی · قرمز نئونی) با انیمیشن، حالت نمایش موبایل (mockup)
- 🔄 **به‌روزرسانی خودکار نسخه** — بدون نیاز به سرور اختصاصی؛ آخرین فایل `.apk` به‌صورت آنلاین تشخیص داده می‌شود (الان: v4.5؛ هر زمان منبع آپدیت شود به‌صورت خودکار v4.6 و… نمایش داده می‌شود)
